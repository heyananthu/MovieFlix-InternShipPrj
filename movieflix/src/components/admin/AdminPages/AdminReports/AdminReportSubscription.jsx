...
function AdminReportSubscription() {
        ...
        <div>
            <div className='flex p-5 rounded-lg shadow-2xl shadow-slate-800  h-[10rem] w-[20rem] mt-24'>
                <div>
                    ...
                    <Link to={'/adminsubcriptionview'} className='text-red-600 mt-6 block font-black text-lg font-mono text-nowrap'>view all</Link>
                </div>
...
export default AdminReportSubscription
